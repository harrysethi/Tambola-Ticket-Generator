...
public class Solution {
	...
	static class Node{
		...
		private void sortColumnWithTwoNumbers(int c) throws Exception {
			...
			int cell1, cell2;
			if (emptyCell == 0) { cell1 = 1; cell2 = 2; }
			else if (emptyCell == 1) { cell1 = 0; cell2 = 2; }
			else { cell1 = 0; cell2 = 1; } // emptyCell == 2
		...
		private void sortColumn(int c) throws Exception {
			if (this.getColCount(c) == 1) { return; }
			
			else if (this.getColCount(c) == 2) { this.sortColumnWithTwoNumbers(c); }
			
			else { this.sortColumnWithThreeNumbers(c); }
		}
	...
	public static void main(String[] args) {
		...
		catch (Exception e)
		{
			...
			System.out.println("Note: there is a small probability your columns may not be sorted, it should not impact the gameplay");
